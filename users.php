              ...
              <div class="card-body">
                ...
                <div class="tab-content pt-5" id="nav-tabContent">
                  <div class="tab-pane fade show active" id="nav-employees" role="tabpanel" aria-labelledby="nav-employees-tab" tabindex="0">
                    <table id="tblemployees" class="display" style="width:100%;display:none;">
                      <thead>
                        <tr>
                          <th>ID No.</th>
                          <th>Employee</th>
                  ...
                  <div class="tab-pane fade" id="nav-staffs" role="tabpanel" aria-labelledby="nav-staffs-tab" tabindex="0">
                    <table id="tblstaffs" class="display" style="width:100%;display:none;">
                      <thead>
                        <tr>
                          <th>ID No.</th>
                          <th>Employee</th>
                  ...
                  <div class="tab-pane fade" id="nav-officers" role="tabpanel" aria-labelledby="nav-officers-tab" tabindex="0">
                    <table id="tblofficers" class="display" style="width:100%;display:none;">
                      <thead>
                        <tr>
                          <th>ID No.</th>
                          <th>Employee</th>
                  ...
                  <script>
                    jQuery(document).ready(function() {
                      var tblemployees = $('#tblemployees').DataTable({
                        ...
                        "serverSide": true,
                        "responsive": true,
                        "ajax": "assets/components/includes/datatables/tblemployees.php",
                        "initComplete": function(settings, json) {
                          $('#tblemployees').show();

                        }
                      });
                      var tblstaffs = $('#tblstaffs').DataTable({
                        "processing": true,
                        "serverSide": true,
                        "responsive": true,
                        "ajax": "assets/components/includes/datatables/tblstaffs.php",
                        "initComplete": function(settings, json) {
                          $('#tblstaffs').show();

                        }
                      });
                      var tblofficers = $('#tblofficers').DataTable({
                        "processing": true,
                        "serverSide": true,
                        "responsive": true,
                        "ajax": "assets/components/includes/datatables/tblofficers.php",
                        "initComplete": function(settings, json) {
                          $('#tblofficers').show();
