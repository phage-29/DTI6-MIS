                            ...
                            <form class="needs-validation" novalidate>
                                ...
                                <div class="row mb-2 crit2">
                                    <div class="col-lg-6 col-md-12 col-sm-12 small">
                                        ...
                                        <p>Actual services are acted upon immediately. Delivery of service are complete,
                                ...
                                <div class="row mb-2 crit3">
                                    <div class="col-lg-6 col-md-12 col-sm-12 small">
                                        ...
                                        <p>Computer and Technology facilities and services are sustainable and available
                                            when needed.</p>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 row">
                                        <div class="col-3 small text-center">
                                ...
                                <div class="row mb-2 overall">
                                    <div class="col-lg-6 col-md-12 col-sm-12 small">
                                        ...
                                        <p>Overall, how satisfied are you with the technology facilities and services
                                            available?</p>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 row">
                                        <div class="col-3 small text-center">
                                ...
                                <div class="mb-2">
                                    <label for="reasons" class="small">Please write in the space below your reason/s for
                                        your "DISSATISFIED" or "VERY DISSATISFIED" rating so that we will know in which
